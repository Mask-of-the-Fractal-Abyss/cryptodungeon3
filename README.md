...
it's similar to cryptocurrency because finding rooms represents computational work
another significant theme of the game is the acquisition of procedurally generated knowledge
there are items and spells in the game, but you must discover their recipes and verses in order to cast them.  Then you can also build machines which automatically produce those resources.
